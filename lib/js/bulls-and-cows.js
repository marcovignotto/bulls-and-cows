...
// // const createArrNumbers = (arr, start, total) => {
// //   for (let i = start; i < total + 1; i++) {
// //     arr.push(i);
// //   }
// // };

// playerMachine = ["1", "2", "3", "4"];
// let player = ["1", "2", "4", "3"];

// console.log("playerMachine", playerMachine);
...
// console.log(
//   `Player played ${player.join("")} and has ${bulls} bulls and ${cows} cows`
// );
// console.log(bulls);

// const giveHints = arr=> arr.map(x=> x=== 'bull' : console.log(''))
